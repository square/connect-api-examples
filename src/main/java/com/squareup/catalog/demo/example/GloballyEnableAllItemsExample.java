...
public class GloballyEnableAllItemsExample extends Example {
    ...
    private int totalItemsUpdated = 0;
                ...
                if (items == null || items.size() == 0) {
                    ...
                    for (CatalogObject itemObject : items) {
                        ...
                        if (isRegularItem && !isGloballyEnabled) {
                            ...
                            // Newer SDKs don't have a setter for fields, so we need to reconstruct the object with
                    ...
                    if(itemsToUpdate.size() > 0) {
                        BatchUpsertCatalogObjectsRequest batchUpsertRequest = new BatchUpsertCatalogObjectsRequest.Builder(
                            ...
                            singletonList(new CatalogObjectBatch(itemsToUpdate)))
                            .build();
