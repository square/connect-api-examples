...
const Home: React.FC<HomeProps> = () => {
  ...
  return <>
        {currentStep === 0 &&
          <Layout title="Select a Customer" subTitle='src/components/Customers/index.tsx'>
            <Customers />
          </Layout>
        }
        {currentStep === 1 &&
        <Layout title='Select a Subscription Plan' subTitle='src/components/SubscriptionPlans/index.tsx'>
          <SubscriptionPlans/>
        </Layout>
        }
        {currentStep === 2 &&
        <Layout title='Select Catalog Items' subTitle='src/components/ItemCatalog/index.tsx'>
          <ItemCatalog/>
        </Layout>
        }
        {currentStep === 3 &&
        ...
        <Toast className='fixed bottom-8 left-1/2 transform -translate-x-1/2 '>
          ...
          <div className=" ml-4 text-sm font-normal">Subscription Successfully Created</div>
          <Toast.Toggle onDismiss={() => dispatch({type: 'DISMISS_TOAST', payload: null})} />
        </Toast>
      )}
      </div>
      </>
