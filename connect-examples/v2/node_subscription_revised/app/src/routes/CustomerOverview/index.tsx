...
const CustomerOverview: React.FC<CustomerOverviewProps> = () => {
    ...
    <div className="flex items-start">
            <CustomerTile customer={customer} isActionable={false} isLoading={isCustomerLoading}/>
            <SubscriptionsTable subscriptions={subscriptions} isLoading={isSubscriptionsLoading}/>
        </div>
    </ComponentLayout>
    </div>
}
