...
import { SubscriptionPlanData, SubscriptionPlanVariation } from '../components/SubscriptionPlans';
...
export const AppDispatchContext = createContext((() => {}) as React.Dispatch<Action>);
    ...
    switch (action.type) {
      ...
      case 'SET_SUBSCRIPTION':
        return {
          ...
          isNextDisabled: false,
          selectedSubscriptionPlanVariation: action.payload.selectedSubscriptionPlanVariation
        }
      case 'SET_ITEMS':
        return {
          ...state,
