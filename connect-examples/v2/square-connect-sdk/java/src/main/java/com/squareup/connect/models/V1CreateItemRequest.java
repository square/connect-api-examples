...
public class V1CreateItemRequest {
  @JsonProperty("body")
  private V1Item body = null;

  public V1CreateItemRequest body(V1Item body) {
    this.body = body;
    return this;
  }
  ...
  **/
  ...
  public void setBody(V1Item body) {
    this.body = body;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.body, v1CreateItemRequest.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1CreateItemRequest {\n");
