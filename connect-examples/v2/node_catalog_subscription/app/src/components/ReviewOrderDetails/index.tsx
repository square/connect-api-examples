...
const ReviewOrderDetails: React.FC<ReviewOrderDetailsProps> = () => {
  ...
  const originalTotal = selectedItems.reduce((acc, item) => {
    return (
      acc +
      Number(item.itemData.variations[0].itemVariationData.priceMoney.amount)
    );
  }, 0);
      ...
      <div className="flex-col bg-white p-4 rounded mr-4">
        ...
        <div className="my-4 flex justify-around">
          ...
          <div className="mr-4">
            ...
            <p className="text-xl font-semibold">
              Due Today: <span className="text-green-500 font-bold">$1.00</span>
            </p>
          ...
          <div>
            ...
            <p className="text-lg font-semibold mb-2">
              Starting:{" "}
              <span className="p-2 bg-gray-200 rounded-xl mr-2">
                {formattedDate}
              </span>
            </p>
            {/* Total Prices */}
            <div className="flex flex-col">
              <div className="flex items-center">
                ...
                <span className="line-through text-gray-500 ml-2 font-bold">
              ...
              <div className="flex items-center">
                ...
                <span className="p-1 rounded-xl bg-green-200 ml-2 font-bold text-green-500">
                  Save 10%
                </span>
              </div>
            </div>
        ...
        <div className="flex">
          <div className="mr-4 min-w-96">
            <CustomerTile customer={selectedCustomer} isActionable={false} />
          </div>
          <div className="mr-4 min-w-96">
            <SubscriptionTile
              showButton={false}
        ...
        <div className="flex mt-4">
          {selectedItems.map((item, i) => (
            <div key={i} className="mr-4 min-w-96">
              <ItemTile item={item} isActionable={false} />
            </div>
          ))}
        </div>
      </div>
